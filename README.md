...
> :warning: **Remarkable Software Version 3 is EXPERIMENTAL** :warning:<br/>
> This fork contains rudimentary support for the lines v6 format. Only
> strokes are supported, no text annotations.
